...
<div align="center">
    ...
    $_POST['old_p'] = hash("sha256", $_POST['old_p']);
    ...
    $statement->execute();
    ?>
    <h2>La password è stata modificata!
        <h2><br>
            <button class="button" onclick="window.open('userPage.php'); window.close()"> Torna ai tuoi dati</button>
            <?php
            } else {
            ?>
            <h2>La vecchia password è errata!<br>La password non è stata modificata!
                <h2><br>
                    <button class="button" onclick="window.open('userPage.php'); window.close()"> Torna ai tuoi dati
                    </button>&emsp;
                    <button class="button" onclick="window.open('userPagePassword.php'); window.close()"> Prova di
                        nuovo
                    </button>
                    <?php
                    }
                    ...
                    ?>
                    <h1>Al tuo indirizzo e-mail è stata mandata la tua vecchia password
                        <h1><br>
                            <button class="button" onclick="window.open('userPage.php'); window.close()"> Torna ai tuoi
                                dati
                            </button>
                            <?php
                            die();
